...
rep('대화 화자 이름', "jpIsJa()?['윤식','店主']", "jpIsJa()?['학습자','店主']");
/* 프리토킹 AI 역할 프롬프트는 다개국 대응하면서 목적지·언어를 조립하는 형태로 바뀌었고,
   그 과정에서 개인 경력('F&B 경력자')이 사라졌다. 남아 있으면 아래 BANNED 가 잡는다. */
...
for (const must of [
  ...
  'function asContext()', 'function asAsk()', 'function AS_RULES_NOW()',
  ...
  'const FM_MONEY=', 'function fmMoney()', 'function FM_KINDS_NOW()', 'function FM_REGIONS_NOW()',
  ...
  'function wxSoon(h)', 'function shGrabUrl(s)', 'function shHandle()',
  'function shBase()', 'function shGuideHTML()', 'const LV_LINKS=', 'function lvHTML()',
]) {
